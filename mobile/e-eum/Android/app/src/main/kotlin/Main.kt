...
internal val logger: SkipLogger = SkipLogger(subsystem = "e_.eum", category = "E_Eum")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        E_EumAppDelegate.shared.onStart()
    }

    override fun onResume() {
        super.onResume()
        E_EumAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        E_EumAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        E_EumAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        E_EumAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        E_EumAppDelegate.shared.onLowMemory()
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            E_EumRootView().Compose(context = contentContext)
        }
    }
}
